...
INSTALLER_VERSION=1.0.9 # This must be incremented for every new release
INSTALLER_RELEASE_DATE=2019-06-04
...
RQTC_VERSION=0.3.7.0
RQTC_RELEASE_DATE=2019-06-04
