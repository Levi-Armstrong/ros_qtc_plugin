...
Component.prototype.createOperations = function()
{
    try {
        ...
        //component.addOperation("Move", "@TargetDir@/maintenancetool", "@TargetDir@/RosPluginMaintenanceTool");
    } catch (e) {
        console.log(e);
    }
}
...
Component.prototype.dynamicPageEntered = function ()
{
    ...
    if (pageWidget != null) {
        console.log("Setting the ROS info text.")
        pageWidget.m_pageLabel.text = "Please select path where\n\nQtCreator was installed on your system.\n\nExample: /opt/Qt/Tools/QtCreator";
    }
}
